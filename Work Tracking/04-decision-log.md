...
| DEC-014 | 2026-07-08 | Client self-training ("Train" tab) is retained and reframed as **top-of-funnel acquisition**, not a solo product. Free solo lifters build a habit + data trail, then upgrade via one-tap "Connect a coach" into trainer-billable clients. | Refines DEC-001: trainer-first remains the **monetization core**, but solo is the cheapest client-acquisition channel (Hevy/Strong playbook). Resolves the contradiction of shipping a solo tab under a "not solo" thesis. Evidence: `Brain/12-competitive-landscape.md`, `Work Tracking/13-strategy-brief.md`. | Proposed |
| DEC-015 | 2026-07-08 | Positioning is **AI coaching copilot, not workout generator**, sold at **one flat price with nutrition + AI included and no payment skim**. Differentiate on trainer decision-support (the `ai_recommendations` brain), a lovable client app, and honest pricing. | "AI writes workouts" is commoditized; 77% of coaches say AI can't replace them; incumbents stack add-ons / skim 5%. Whitespace = AI that helps the coach decide + client-app love + pricing honesty. Pricing numbers in `13-strategy-brief.md §4` require unit-economics validation before locking. | Proposed |
